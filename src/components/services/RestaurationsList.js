...
export const getRestaurants = async () => {
  return await axios.get(
    "https://api.foodapp.academy.st.cetuspro.com/restaurants"
  );
};
export const getRestaurantsByName = async (name) => {
  return await axios.get(
    `https://api.foodapp.academy.st.cetuspro.com/restaurants/name/${name}`
  );
};
export const getRestaurantsById = async (id) => {
  return await axios.get(
    `https://api.foodapp.academy.st.cetuspro.com/restaurants/${id}`
  );
};
